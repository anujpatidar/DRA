...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[#5F00D9] to-[#4700A3] text-white">
      <div className=" py-[40px] px-[20px] md:px-[100px]">
        <div className="flex flex-col w-full md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/sitemap" className="text-sm hover:text-gray-200">
              SITEMAP
            </Link>
